        ...
        OnGetPoiSearchResultListener getPoiSearchResultListener=new OnGetPoiSearchResultListener() {
            ...
            public void onGetPoiResult(PoiResult poiResult) {
                ...
                if(poiResult.error== SearchResult.ERRORNO.RESULT_NOT_FOUND){
                    Log.d("aa",poiResult.error.toString());
                     return;
                }
...
//                    overlay.zoomToSpan();
    ...
    private void setMapText(){
      OverlayOptions overlayOptions=new TextOptions().text("机电").fontColor(0XFFFF00FF).fontSize(24).bgColor(0xAAFFFF00).position(dajidian).rotate(45);
    ...
    private void  POISearch(){
        ...
        mPoiSearch.searchNearby(new PoiNearbySearchOption().location(dajidian).keyword("超市").radius(10000).pageNum(1));
    }
